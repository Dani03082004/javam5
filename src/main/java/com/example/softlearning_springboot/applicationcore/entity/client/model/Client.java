...
public class Client extends Person implements Stakeholder { 
    ...
    public static Client getInstance(int id, String name, String address, String cognoms, int phoneNumber,
            ...
            String birthday, String dni, int age, int workers, String socialReason)
        ...
        try {
            cl.CheckPersonData(id, name, address, cognoms, phoneNumber, postalCode, email, birthday);
    ...
    public boolean setAge(int age) {
        if (Checker.NotNegative((int) age) != 0) {
            return false;
        }
        this.age = age;
        return true;
